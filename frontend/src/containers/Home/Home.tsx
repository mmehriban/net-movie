    ...
    <div>
      <div className=''>
          <div className='relative' style={{ height: '100vh', width: '100vw', overflow: 'hidden' }} >
            ...
            <div className='absolute top-80 left-16 z-10 text-white'>
            <h1 className='text-7xl font-bold pt-5'>Name of the movie</h1>
            <p className='text-lg pt-5'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Optio harum <br/> maiores architecto, quis suscipit sed.</p>
